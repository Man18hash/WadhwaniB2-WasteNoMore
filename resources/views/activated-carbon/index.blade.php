...
@section('title', 'Activated Carbon')
@section('page-title', 'Activated Carbon')
@section('page-description', 'Manage activated carbon production batches')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h2 class="text-2xl font-semibold text-gray-800">Activated Carbon Production</h2>
            <p class="text-gray-600">Track activated carbon production from fruit seeds and hard waste</p>
        </div>
        <div class="flex space-x-3">
            <a href="{{ route('activated-carbon.create') }}" class="bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form method="GET" action="{{ route('activated-carbon.index') }}" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="{{ route('activated-carbon.show', $batch) }}" class="text-blue-600 hover:text-blue-900">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('activated-carbon.edit', $batch) }}" class="text-indigo-600 hover:text-indigo-900">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form method="POST" action="{{ route('activated-carbon.destroy', $batch) }}" class="inline" onsubmit="return confirm('Are you sure you want to delete this batch?')">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <p class="text-lg">No activated carbon batches found</p>
